...
int main(void)
{
    ...
    for (int i = 0; i < 3; i++)
  1e:	83 c3 01             	add    $0x1,%ebx
  21:	83 fb 03             	cmp    $0x3,%ebx
  24:	75 ef                	jne    15 <main+0x15>
  26:	eb fe                	jmp    26 <main+0x26>
  28:	8d 75 c4             	lea    -0x3c(%ebp),%esi
  2b:	90                   	nop
  ...
  33:	56                   	push   %esi
  34:	e8 29 03 00 00       	call   362 <getpinfo>
  ...
  39:	ff 75 e4             	pushl  -0x1c(%ebp)
  3c:	ff 75 e0             	pushl  -0x20(%ebp)
  3f:	ff 75 dc             	pushl  -0x24(%ebp)
  42:	ff 75 d8             	pushl  -0x28(%ebp)
  45:	ff 75 d4             	pushl  -0x2c(%ebp)
  48:	ff 75 d0             	pushl  -0x30(%ebp)
  4b:	ff 75 cc             	pushl  -0x34(%ebp)
  4e:	ff 75 c8             	pushl  -0x38(%ebp)
  51:	ff 75 c4             	pushl  -0x3c(%ebp)
  54:	53                   	push   %ebx
  55:	68 30 07 00 00       	push   $0x730
  5a:	6a 01                	push   $0x1
  5c:	e8 af 03 00 00       	call   410 <printf>
                sleep(3);
  61:	83 c4 34             	add    $0x34,%esp
  64:	6a 03                	push   $0x3
  66:	e8 d7 02 00 00       	call   342 <sleep>
  6b:	83 c4 10             	add    $0x10,%esp
  6e:	eb c0                	jmp    30 <main+0x30>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 94 07 00 00 	movzbl 0x794(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 8c 07 00 00       	mov    $0x78c,%eax
...
free(void *ap)
{
 ...
 5b1:	a1 34 0a 00 00       	mov    0xa34,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 607:	89 08                	mov    %ecx,(%eax)
  freep = p;
 609:	a3 34 0a 00 00       	mov    %eax,0xa34
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 62d:	a3 34 0a 00 00       	mov    %eax,0xa34
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 34 0a 00 00    	mov    0xa34,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 704:	eb e9                	jmp    6ef <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 706:	c7 05 34 0a 00 00 38 	movl   $0xa38,0xa34
 70d:	0a 00 00 
 710:	c7 05 38 0a 00 00 38 	movl   $0xa38,0xa38
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 38 0a 00 00       	mov    $0xa38,%eax
 71f:	c7 05 3c 0a 00 00 00 	movl   $0x0,0xa3c
 726:	00 00 00 
