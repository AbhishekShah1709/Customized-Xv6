  ...
  22:	eb fe                	jmp    22 <main+0x22>
    {
        ...
        {
            chpr(80-i);
  24:	b8 50 00 00 00       	mov    $0x50,%eax
  29:	83 ec 0c             	sub    $0xc,%esp
  2c:	29 d8                	sub    %ebx,%eax
  2e:	50                   	push   %eax
  2f:	e8 16 03 00 00       	call   34a <chpr>
            sleep(i*100);
  34:	6b c3 64             	imul   $0x64,%ebx,%eax
...
putc(int fd, char c)
{
 ...
 518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 51b:	b8 24 07 00 00       	mov    $0x724,%eax
...
free(void *ap)
{
 ...
 5a1:	a1 c8 09 00 00       	mov    0x9c8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 c8 09 00 00       	mov    %eax,0x9c8
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 c8 09 00 00       	mov    %eax,0x9c8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 c8 09 00 00    	mov    0x9c8,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 68f:	76 3f                	jbe    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	39 05 c8 09 00 00    	cmp    %eax,0x9c8
 ...
 6b6:	e8 e5 fe ff ff       	call   5a0 <free>
  return freep;
 6bb:	8b 15 c8 09 00 00    	mov    0x9c8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6df:	89 15 c8 09 00 00    	mov    %edx,0x9c8
      return (void*)(p + 1);
 ...
 6f4:	eb e9                	jmp    6df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 05 c8 09 00 00 cc 	movl   $0x9cc,0x9c8
 6fd:	09 00 00 
 700:	c7 05 cc 09 00 00 cc 	movl   $0x9cc,0x9cc
 707:	09 00 00 
    base.s.size = 0;
 70a:	b8 cc 09 00 00       	mov    $0x9cc,%eax
 70f:	c7 05 d0 09 00 00 00 	movl   $0x0,0x9d0
 716:	00 00 00 
