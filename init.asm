...
//  chpr(getpid(), 1);
  ...
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 c0 0a 00 00       	push   $0xac0
  ab:	68 f9 07 00 00       	push   $0x7f9
  b0:	e8 b5 02 00 00       	call   36a <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 fc 07 00 00       	push   $0x7fc
  bc:	6a 01                	push   $0x1
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 1b 08 00 00       	mov    $0x81b,%eax
...
free(void *ap)
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ad:	a3 c8 0a 00 00       	mov    %eax,0xac8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 c8 0a 00 00 cc 	movl   $0xacc,0xac8
 78d:	0a 00 00 
 790:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 cc 0a 00 00       	mov    $0xacc,%eax
