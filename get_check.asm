...
_get_check:     file format elf32-i386
...
//    sleep(1);
  ...
  19:	6a 24                	push   $0x24
  1b:	e8 00 07 00 00       	call   720 <malloc>
  20:	89 c6                	mov    %eax,%esi
    int pid;
    pid=getpinfo(p);
  22:	89 04 24             	mov    %eax,(%esp)
  25:	e8 18 04 00 00       	call   442 <getpinfo>

    printf(1,"process %s with id %d\nruntime : %d\nnum_run %d\nticks\ncurrent_queue : %d\nticks : %d %d %d %d %d\n",argv[1],p->pid,p->runtime,p->num_run,p->current_queue,p->ticks[0],p->ticks[1],p->ticks[2],p->ticks[3],p->ticks[4]);
  2a:	ff 76 20             	pushl  0x20(%esi)
  2d:	ff 76 1c             	pushl  0x1c(%esi)
  30:	ff 76 18             	pushl  0x18(%esi)
  33:	ff 76 14             	pushl  0x14(%esi)
  36:	ff 76 10             	pushl  0x10(%esi)
  39:	ff 76 0c             	pushl  0xc(%esi)
  3c:	ff 76 08             	pushl  0x8(%esi)
  3f:	ff 76 04             	pushl  0x4(%esi)
  42:	ff 36                	pushl  (%esi)
  44:	ff 77 04             	pushl  0x4(%edi)
  47:	68 10 08 00 00       	push   $0x810
  4c:	6a 01                	push   $0x1
  4e:	e8 9d 04 00 00       	call   4f0 <printf>
  53:	83 c4 40             	add    $0x40,%esp
  ...
  76:	81 fb f4 01 00 00    	cmp    $0x1f4,%ebx
  ...
  81:	31 db                	xor    %ebx,%ebx
    ...
    //sleep(1000);
    printf(1,"\n");
  83:	68 7c 08 00 00       	push   $0x87c
  88:	6a 01                	push   $0x1
  8a:	e8 61 04 00 00       	call   4f0 <printf>
    pid=getpinfo(p);
  8f:	89 34 24             	mov    %esi,(%esp)
  92:	e8 ab 03 00 00       	call   442 <getpinfo>
    

    printf(1,"process %s with id %d\nruntime : %d\nnum_run %d\nticks\ncurrent_queue : %d\nticks : %d %d %d %d %d\n",argv[1],p->pid,p->runtime,p->num_run,p->current_queue,p->ticks[0],p->ticks[1],p->ticks[2],p->ticks[3],p->ticks[4]);
  97:	ff 76 20             	pushl  0x20(%esi)
  9a:	ff 76 1c             	pushl  0x1c(%esi)
  9d:	ff 76 18             	pushl  0x18(%esi)
  a0:	ff 76 14             	pushl  0x14(%esi)
  a3:	ff 76 10             	pushl  0x10(%esi)
  a6:	ff 76 0c             	pushl  0xc(%esi)
  a9:	ff 76 08             	pushl  0x8(%esi)
  ac:	ff 76 04             	pushl  0x4(%esi)
  af:	ff 36                	pushl  (%esi)
  b1:	ff 77 04             	pushl  0x4(%edi)
  b4:	68 10 08 00 00       	push   $0x810
  b9:	6a 01                	push   $0x1
  bb:	e8 30 04 00 00       	call   4f0 <printf>
  c0:	83 c4 40             	add    $0x40,%esp
  c3:	90                   	nop
  ...
  de:	81 fb f4 01 00 00    	cmp    $0x1f4,%ebx
  e4:	75 e2                	jne    c8 <main+0xc8>
        printf(1,"%d",i);
    //sleep(1000);
    printf(1,"\n");
  e6:	83 ec 08             	sub    $0x8,%esp
  e9:	68 7c 08 00 00       	push   $0x87c
  ee:	6a 01                	push   $0x1
  f0:	e8 fb 03 00 00       	call   4f0 <printf>
    pid=getpinfo(p);
  f5:	89 34 24             	mov    %esi,(%esp)
  f8:	e8 45 03 00 00       	call   442 <getpinfo>

    printf(1,"process %s with id %d\nruntime : %d\nnum_run %d\nticks\ncurrent_queue : %d\nticks : %d %d %d %d %d\n",argv[1],p->pid,p->runtime,p->num_run,p->current_queue,p->ticks[0],p->ticks[1],p->ticks[2],p->ticks[3],p->ticks[4]);
  fd:	ff 76 20             	pushl  0x20(%esi)
 100:	ff 76 1c             	pushl  0x1c(%esi)
 ...
 103:	89 c3                	mov    %eax,%ebx
    ...
    printf(1,"process %s with id %d\nruntime : %d\nnum_run %d\nticks\ncurrent_queue : %d\nticks : %d %d %d %d %d\n",argv[1],p->pid,p->runtime,p->num_run,p->current_queue,p->ticks[0],p->ticks[1],p->ticks[2],p->ticks[3],p->ticks[4]);
 105:	ff 76 18             	pushl  0x18(%esi)
 108:	ff 76 14             	pushl  0x14(%esi)
 10b:	ff 76 10             	pushl  0x10(%esi)
 10e:	ff 76 0c             	pushl  0xc(%esi)
 111:	ff 76 08             	pushl  0x8(%esi)
 114:	ff 76 04             	pushl  0x4(%esi)
 117:	ff 36                	pushl  (%esi)
 119:	ff 77 04             	pushl  0x4(%edi)
 11c:	68 10 08 00 00       	push   $0x810
 121:	6a 01                	push   $0x1
 123:	e8 c8 03 00 00       	call   4f0 <printf>

    printf(1,"\n");
 128:	83 c4 38             	add    $0x38,%esp
 12b:	68 7c 08 00 00       	push   $0x87c
 130:	6a 01                	push   $0x1
 132:	e8 b9 03 00 00       	call   4f0 <printf>
    printf(1,"pid -- %d\n",pid);
 137:	83 c4 0c             	add    $0xc,%esp
 13a:	53                   	push   %ebx
 13b:	68 73 08 00 00       	push   $0x873
 140:	6a 01                	push   $0x1
 142:	e8 a9 03 00 00       	call   4f0 <printf>
    exit();
 147:	e8 46 02 00 00       	call   392 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48f:	f7 f6                	div    %esi
 491:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 608:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 60b:	b8 7e 08 00 00       	mov    $0x87e,%eax
...
free(void *ap)
{
 ...
 6e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6e9:	a3 2c 0b 00 00       	mov    %eax,0xb2c
}
 6ee:	5b                   	pop    %ebx
 6ef:	5e                   	pop    %esi
 6f0:	5f                   	pop    %edi
 ...
 70a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 70d:	a3 2c 0b 00 00       	mov    %eax,0xb2c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 2c 0b 00 00    	mov    0xb2c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7cf:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
      return (void*)(p + 1);
 ...
 7e4:	eb e9                	jmp    7cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7e6:	c7 05 2c 0b 00 00 30 	movl   $0xb30,0xb2c
 7ed:	0b 00 00 
 7f0:	c7 05 30 0b 00 00 30 	movl   $0xb30,0xb30
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	b8 30 0b 00 00       	mov    $0xb30,%eax
 7ff:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 806:	00 00 00 
