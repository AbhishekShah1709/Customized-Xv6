...
int main(int argc, char *argv[])
{
  ...
  20:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
int main(int argc, char *argv[])
{
    int pid;
    int k,n;
    int x, z;
    int *rtime = malloc(sizeof(int));
  27:	89 45 e0             	mov    %eax,-0x20(%ebp)
    int *wtime = malloc(sizeof(int));
  2a:	e8 f1 06 00 00       	call   720 <malloc>
    if (argc != 2)
  2f:	83 c4 10             	add    $0x10,%esp
  32:	83 fb 02             	cmp    $0x2,%ebx
{
    int pid;
    int k,n;
    int x, z;
  ...
  35:	89 c6                	mov    %eax,%esi
    if (argc != 2)
  37:	74 12                	je     4b <main+0x4b>
    {
        printf(2, "usage: %s n\n", argv[0]);
  39:	51                   	push   %ecx
  3a:	ff 37                	pushl  (%edi)
  3c:	68 10 08 00 00       	push   $0x810
  41:	6a 02                	push   $0x2
  ...
  4e:	ff 77 04             	pushl  0x4(%edi)
  51:	e8 ca 02 00 00       	call   320 <atoi>
  56:	89 c7                	mov    %eax,%edi
    if (fork() == 0)
  58:	e8 2d 03 00 00       	call   38a <fork>
  5d:	83 c4 10             	add    $0x10,%esp
  60:	85 c0                	test   %eax,%eax
  62:	75 27                	jne    8b <main+0x8b>
    {
        for (k = 0; k < n; k++)
  64:	31 db                	xor    %ebx,%ebx
  66:	85 ff                	test   %edi,%edi
  68:	7f 13                	jg     7d <main+0x7d>
  6a:	eb 1a                	jmp    86 <main+0x86>
  ...
  77:	0f 84 8f 00 00 00    	je     10c <main+0x10c>
        {
            pid = fork();
  7d:	e8 08 03 00 00       	call   38a <fork>
            if (pid < 0)
  82:	85 c0                	test   %eax,%eax
  84:	79 ea                	jns    70 <main+0x70>
            {
                exit();
  86:	e8 07 03 00 00       	call   392 <exit>
  ...
  8b:	8b 5d e0             	mov    -0x20(%ebp),%ebx
  8e:	50                   	push   %eax
  8f:	50                   	push   %eax
  90:	53                   	push   %ebx
  91:	56                   	push   %esi
  92:	e8 9b 03 00 00       	call   432 <waitx>
        printf(1,"time=%d\n",(*rtime)+(*wtime));
  97:	8b 16                	mov    (%esi),%edx
  99:	03 13                	add    (%ebx),%edx
  ...
  bd:	e8 d0 02 00 00       	call   392 <exit>
            ...
            {
                chpr(80-k);
  c2:	b8 50 00 00 00       	mov    $0x50,%eax
  c7:	83 ec 0c             	sub    $0xc,%esp
  ca:	29 d8                	sub    %ebx,%eax
                sleep(1000);
  cc:	bb 80 96 98 00       	mov    $0x989680,%ebx
            {
                exit();
            }
            else if (pid == 0)
            {
                chpr(80-k);
  d1:	50                   	push   %eax
  d2:	e8 63 03 00 00       	call   43a <chpr>
                sleep(1000);
  d7:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
  de:	e8 3f 03 00 00       	call   422 <sleep>
 ...
 107:	e9 7a ff ff ff       	jmp    86 <main+0x86>
 ...
 10e:	66 90                	xchg   %ax,%ax
        ...
        {
            int pid = waitx(wtime, rtime);
 110:	8b 5d e0             	mov    -0x20(%ebp),%ebx
 113:	83 ec 08             	sub    $0x8,%esp
 116:	89 55 e4             	mov    %edx,-0x1c(%ebp)
 119:	53                   	push   %ebx
 11a:	56                   	push   %esi
 11b:	e8 12 03 00 00       	call   432 <waitx>
            printf(1,"Process with pid=%d wtime=%d rtime=%d\n",pid,*wtime,*rtime);
 120:	5a                   	pop    %edx
 121:	ff 33                	pushl  (%ebx)
 123:	ff 36                	pushl  (%esi)
 125:	50                   	push   %eax
 126:	68 34 08 00 00       	push   $0x834
 12b:	6a 01                	push   $0x1
 ...
 13b:	39 d7                	cmp    %edx,%edi
 13d:	75 d1                	jne    110 <main+0x110>
 13f:	e9 42 ff ff ff       	jmp    86 <main+0x86>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48f:	f7 f6                	div    %esi
 491:	0f b6 92 64 08 00 00 	movzbl 0x864(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 608:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 60b:	b8 5c 08 00 00       	mov    $0x85c,%eax
...
free(void *ap)
{
 ...
 691:	a1 08 0b 00 00       	mov    0xb08,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6e9:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 6ee:	5b                   	pop    %ebx
 6ef:	5e                   	pop    %esi
 6f0:	5f                   	pop    %edi
 ...
 70a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 70d:	a3 08 0b 00 00       	mov    %eax,0xb08
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 08 0b 00 00    	mov    0xb08,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7cf:	89 15 08 0b 00 00    	mov    %edx,0xb08
      return (void*)(p + 1);
 ...
 7e4:	eb e9                	jmp    7cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7e6:	c7 05 08 0b 00 00 0c 	movl   $0xb0c,0xb08
 7ed:	0b 00 00 
 7f0:	c7 05 0c 0b 00 00 0c 	movl   $0xb0c,0xb0c
 7f7:	0b 00 00 
    base.s.size = 0;
 7fa:	b8 0c 0b 00 00       	mov    $0xb0c,%eax
 7ff:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 806:	00 00 00 
