...
int main ()
{
  ...
  11:	31 db                	xor    %ebx,%ebx
        ...
        {
            chpr(i%5);
  13:	be 67 66 66 66       	mov    $0x66666667,%esi
#include "stat.h"
#include "user.h"
#include "fs.h"
...
int main ()
{
  ...
  3c:	d1 fa                	sar    %edx
  3e:	29 c2                	sub    %eax,%edx
  40:	8d 04 92             	lea    (%edx,%edx,4),%eax
  43:	29 c1                	sub    %eax,%ecx
  45:	51                   	push   %ecx
  46:	e8 1f 03 00 00       	call   36a <chpr>
            printf(1, "pid=%d\n", pid);
  4b:	83 c4 0c             	add    $0xc,%esp
  4e:	57                   	push   %edi
  4f:	68 40 07 00 00       	push   $0x740
  54:	6a 01                	push   $0x1
...
int main ()
{
  ...
  5e:	83 fb 0a             	cmp    $0xa,%ebx
  61:	75 bd                	jne    20 <main+0x20>
        {
            chpr(i%5);
            printf(1, "pid=%d\n", pid);
        } 
  ...
  74:	6a 0a                	push   $0xa
  76:	e8 d7 02 00 00       	call   352 <sleep>
            exit();
  7b:	e8 42 02 00 00       	call   2c2 <exit>
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 48 07 00 00       	mov    $0x748,%eax
