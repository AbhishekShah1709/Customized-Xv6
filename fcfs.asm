...
int main ()
{
  ...
  24:	83 fb 0a             	cmp    $0xa,%ebx
  27:	75 ef                	jne    18 <main+0x18>
  29:	eb fe                	jmp    29 <main+0x29>
    {
        int pid = fork();
        if (pid == 0)
        {
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 20 07 00 00 	movzbl 0x720(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 16 07 00 00       	mov    $0x716,%eax
